...
function evalCall(instr: bril.Operation, state: State): Action {
    ...
    state.commits = state.commits + newState.commits;
    state.aborts = state.aborts + newState.aborts;
...
function evalFunc(func: bril.Function, state: State): Value | null {
    let lastWasLabel: Boolean = false
...
function evalProg(prog: bril.Program) {
    ...
    console.log(`commits: ${state.commits}, aborts: ${state.aborts}`);
